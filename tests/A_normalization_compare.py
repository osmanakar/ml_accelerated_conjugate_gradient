...
project_folder_subname = "MLV22_T1_N255_ritz_vectors_10000_20000"
...
for i in range(50,77):
    ...
    res_arr_matrix_256[i,0:len(res_arr)]=np.array(res_arr)
...
for i in range(50,77):
    idx_ = 100
    tol_ = 1.0e-1
    if res_arr_matrix_256[i,idx_]<tol_:
        print(i,res_arr_matrix_256[i,idx_])
