...
#%% Dirichlet Matrix
data_folder_name_A_sparse = project_folder_general + "../preconditioner_first_iter_MLV1_N63_dirichlet/data/dirichlet_1side/"
A_sparse = hf.readA_sparse(dim,data_folder_name_A_sparse+"matrixA_n"+str(dim-1)+".bin")
...
project_name = "preconditioner_first_iter_MLV1_N63_dirichlet"
#project_folder_subname = "PFI_MLV22_T1_eigvector_random_N63"
project_folder_subname = "PFI_MLV20_T1_eigvector_random_N63"
n=300
x0 = np.random.normal(0,1, [dim2])
b = A_sparse.dot(x0)
#b = hf.get_frame(n,dim,'mac')
max_it=100
