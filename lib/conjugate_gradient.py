...
class ConjugateGradient:
    ...
    def cg_on_ML_generated_subspace(self, b, x_init, ml_model,max_it=100,tol=1e-10,verbose=True):
        dim2 =len(b)
...
class ConjugateGradientSparse:
    ...
    def cg_on_ML_generated_subspace(self, b, x_init, model_predict, max_it=100,tol=1e-10,verbose=True):
        dim2 =len(b)
        x_sol = np.zeros(b.shape)
        res_arr = []
        p0 = np.zeros(dim2)
