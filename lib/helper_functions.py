...
def get_frame_from_source(n,data_folder_name,normalize = True):
...
"""
#this is written to read sparse matrix format, that is saved in c++ using above code
def readA_sparse(dim, filenameA):
    dim2 = dim*dim
    cols = []
    outerIdxPtr = []
    data = []
