...
sample_size1 = 0
sample_size2 = 6000
coef_matrix[r_cut_idx1:r_cut_idx0,sample_size1:sample_size2] = 9*np.random.normal(0,1, [r_cut_idx0-r_cut_idx1,sample_size2-sample_size1])
coef_matrix[r_cut_idx3:r_cut_idx2,sample_size1:sample_size2] = 9*np.random.normal(0,1, [r_cut_idx2-r_cut_idx3,sample_size2-sample_size1])

#%%
cut_idx0 = 0
cut_idx1 = int(num_ritz_vectors/2)-5000
cut_idx4 = num_ritz_vectors-num_zero_ritz_vals
...
sample_size1 = 6000
sample_size2 = 13000
coef_matrix[r_cut_idx4:r_cut_idx1,sample_size1:sample_size2] = 9*np.random.normal(0,1, [r_cut_idx1-r_cut_idx4,sample_size2-sample_size1])
...
#%%
MLproject_data_folder = project_folder_general+"data/"
with open(project_data_folder+'b_rhs_20000_10000_ritz_vectors_combined_3_N'+str(dim-1)+'.npy', 'wb') as f:
    np.save(f, b_rhs)
#%%
"""
MLproject_data_folder = project_folder_general+"data/"
